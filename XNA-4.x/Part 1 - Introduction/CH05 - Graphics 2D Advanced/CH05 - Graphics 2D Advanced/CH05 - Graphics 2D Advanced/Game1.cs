...
namespace CH05___Graphics_2D_Advanced
{
    /// <summary>
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected bool m_RenderToTexture = false;
        protected RenderTarget2D m_RenderTarget = null;

        // grab the latest pixels from the game screen's back buffer
        // and convert the data to black-and-white
        protected void CaptureGameScreen(bool startCapture)
        {
            ...
            else
            {
                ...
                Texture2D tex = m_RenderTarget as Texture2D;
