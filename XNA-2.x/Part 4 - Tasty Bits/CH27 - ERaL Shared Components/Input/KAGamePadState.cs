...
namespace Codetopia.Input
{
    public class KAGamePadState
    {
        ...
        protected KAGamePadThumbSticks m_ThumbSticks = new KAGamePadThumbSticks();
        ...
        protected bool m_IsConnected = true;
        ...
        public static bool operator !=(KAGamePadState state1, KAGamePadState state2)
        {
